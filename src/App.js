...
const App = () => {
    ...
    return (
        <>
            ...
            <Layout title={'First Component'}  urlBg={bg}
            >
            ...
            <Layout title={'Pokemons'}  colorBg='#e2e2e2'
            >
                <div className="flex">
                    {
                        POKEMONS.map(item => <Cards key={item.id}
                                                    name={item.name}
                                                    id={item.id}
                                                    img={item.img}
                                                    values={item.values}
            ...
            <Layout title={'Three Component'}  urlBg={back}
            >
                <p>To win, a majority of the total ten cards played (including the one card that is not placed on the board)
                    ...
                    opponent's card whereupon the 'ranks' of the sides where the two cards touch will be compared. If the rank of the
                    opponent's card is higher than the player's card, the player's card will be captured and turned into the opponent's color.
